const User = require("../../models/users"); // Replace with your actual path to the Attendance model
...
exports.all = async (req, res) => {
  try {
    ...
    const query = {};
    if (search) {
      query.ds_email = { $regex: search, $options: "i" }; // Case-insensitive regex search
    }
